...
constexpr int kMaxPrimaryLinks = (kMaxPFParticles * 2);
constexpr int kMaxParentChildLinks = (kMaxPFParticles * kMaxPFParticles * 4);
...
private:
  ...
  void SetRecoGenerationInfo(art::Event const & evt, const art::Ptr<recob::PFParticle> &pfp, int &recoGeneration, int &recoParentSelf, int &recoParentPDG, int &recoParentTrackID);
  void SetTrueGenerationMCInfo(art::Event const & evt, const int pfpIndex, const bool visibleMode, int &trueGeneration, int &trueParentTrackID, int &trueParentPDG);
  void SetTrueGenerationRecoInfo(art::Event const & evt);
  int GetPFPIndexFromTrackID(const int trackID);
  ...
  void FillPrimaryLinkInfo(art::Event const & evt);
  bool IsPrimaryLinkOrientationCorrect(const int particleIndex, const bool useRecoStart);
  ...
  int fRecoPFPRecoParentTrackID[kMaxPFParticles];
  ...
  bool fIsRecoTrackInverted[kMaxPFParticles];
  ...
  ////////////////////////////////////////
  // Truth - PrimaryTier
  bool fTruePrimaryLink[kMaxPrimaryLinks];
  bool fIsPrimaryLinkOrientationCorrect[kMaxPrimaryLinks];
  int fTruePrimaryPDG[kMaxPrimaryLinks];
  double fPrimaryCompleteness[kMaxPrimaryLinks];
  double fPrimaryPurity[kMaxPrimaryLinks];
  // Reco - PrimaryTier
  int fNPrimaryLinks;
  int fPrimaryPFPIndex[kMaxPrimaryLinks];
  int fPrimaryNSpacepoints[kMaxPrimaryLinks];
  double fPrimaryTrackScore[kMaxPrimaryLinks];
  double fPrimaryStartX[kMaxPrimaryLinks];
  double fPrimaryStartY[kMaxPrimaryLinks];
  double fPrimaryStartZ[kMaxPrimaryLinks];
  double fPrimaryStartDX[kMaxPrimaryLinks];
  double fPrimaryStartDY[kMaxPrimaryLinks];
  double fPrimaryStartDZ[kMaxPrimaryLinks];
  double fPrimaryNuVertexSeparation[kMaxPrimaryLinks];
  int fPrimaryStartRegionNHits[kMaxPrimaryLinks];
  ...
  bool fIsLinkOrientationCorrect[kMaxParentChildLinks];
  // Reco - HigherTier
  int fNParentChildLinks;
  // Parent information - HigherTier
  ...
  double fParentNSpacepoints[kMaxParentChildLinks];
  double fParentCompleteness[kMaxParentChildLinks];
  double fParentPurity[kMaxParentChildLinks];
  double fChildNSpacepoints[kMaxParentChildLinks];
  double fChildCompleteness[kMaxParentChildLinks];
  double fChildPurity[kMaxParentChildLinks];
  ...
  double fOvershootStartDCA[kMaxParentChildLinks];
  double fOvershootStartL[kMaxParentChildLinks];
  double fOvershootEndDCA[kMaxParentChildLinks];
  double fOvershootEndL[kMaxParentChildLinks];
  double fChildConnectionX[kMaxParentChildLinks];
  double fChildConnectionY[kMaxParentChildLinks];
  double fChildConnectionZ[kMaxParentChildLinks];
  double fChildConnectionDX[kMaxParentChildLinks];
  double fChildConnectionDY[kMaxParentChildLinks];
  double fChildConnectionDZ[kMaxParentChildLinks];
  double fChildConnectionDCA[kMaxParentChildLinks];
  double fChildConnectionExtrapDistance[kMaxParentChildLinks];
  double fChildConnectionL[kMaxParentChildLinks];
  double fChildConnectionLRatio[kMaxParentChildLinks];
  double fParentConnectionPointNUpstreamHits[kMaxParentChildLinks];
  double fParentConnectionPointNDownstreamHits[kMaxParentChildLinks];
...
void FDSelection::CCNuSelection::beginJob()
{
    ...
    fTree->Branch("RecoPFPRecoParentTrackID", fRecoPFPRecoParentTrackID, "RecoPFPRecoParentTrackID[NRecoPFPs]/I");
    ...
    fTree->Branch("IsRecoTrackInverted", fIsRecoTrackInverted, "IsRecoTrackInverted[NRecoPFPs]/O");
    ...
    // Hierarchy Info
    ////////////////////////////////////////
    fTree->Branch("NPrimaryLinks", &fNPrimaryLinks);
    // Truth - PrimaryTier
    fTree->Branch("TruePrimaryLink", &fTruePrimaryLink, "TruePrimaryLink[NPrimaryLinks]/O");
    fTree->Branch("IsPrimaryLinkOrientationCorrect", &fIsPrimaryLinkOrientationCorrect, "IsPrimaryLinkOrientationCorrect[NPrimaryLinks]/O");
    fTree->Branch("TruePrimaryPDG", &fTruePrimaryPDG, "TruePrimaryPDG[NPrimaryLinks]/I");
    fTree->Branch("PrimaryCompleteness", &fPrimaryCompleteness, "PrimaryCompleteness[NPrimaryLinks]/D");
    fTree->Branch("PrimaryPurity", &fPrimaryPurity, "PrimaryPurity[NPrimaryLinks]/D");
    // Reco - PrimaryTier
    fTree->Branch("PrimaryPFPIndex", &fPrimaryPFPIndex, "PrimaryPFPIndex[NPrimaryLinks]/I");
    fTree->Branch("PrimaryNSpacepoints", &fPrimaryNSpacepoints, "PrimaryNSpacepoints[NPrimaryLinks]/I");
    fTree->Branch("PrimaryTrackScore", &fPrimaryTrackScore, "PrimaryTrackScore[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartX", &fPrimaryStartX, "PrimaryStartX[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartY", &fPrimaryStartY, "PrimaryStartY[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartZ", &fPrimaryStartZ, "PrimaryStartZ[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartDX", &fPrimaryStartDX, "PrimaryStartDX[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartDY", &fPrimaryStartDY, "PrimaryStartDY[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartDZ", &fPrimaryStartDZ, "PrimaryStartDZ[NPrimaryLinks]/D");
    fTree->Branch("PrimaryNuVertexSeparation", &fPrimaryNuVertexSeparation, "PrimaryNuVertexSeparation[NPrimaryLinks]/D");
    fTree->Branch("PrimaryStartRegionNHits", &fPrimaryStartRegionNHits, "PrimaryStartRegionNHits[NPrimaryLinks]/I");
    ...
    fTree->Branch("IsHigherTierTrainingLink", &fIsHigherTierTrainingLink, "IsHigherTierTrainingLink[NParentChildLinks]/O");
    fTree->Branch("IsLinkOrientationCorrect", &fIsLinkOrientationCorrect, "IsLinkOrientationCorrect[NParentChildLinks]/O");
    // Parent information
    ...
    fTree->Branch("ParentNSpacepoints", &fParentNSpacepoints, "ParentNSpacepoints[NParentChildLinks]/D");
    fTree->Branch("ParentCompleteness", &fParentCompleteness, "ParentCompleteness[NParentChildLinks]/D");
    fTree->Branch("ParentPurity", &fParentPurity, "ParentPurity[NParentChildLinks]/D");
    fTree->Branch("ChildNSpacepoints", &fChildNSpacepoints, "ChildNSpacepoints[NParentChildLinks]/D");
    fTree->Branch("ChildCompleteness", &fChildCompleteness, "ChildCompleteness[NParentChildLinks]/D");
    fTree->Branch("ChildPurity", &fChildPurity, "ChildPurity[NParentChildLinks]/D");
    ...
    fTree->Branch("OvershootStartDCA", &fOvershootStartDCA, "OvershootStartDCA[NParentChildLinks]/D");
    fTree->Branch("OvershootStartL", &fOvershootStartL, "OvershootStartL[NParentChildLinks]/D");
    fTree->Branch("OvershootEndDCA", &fOvershootEndDCA, "OvershootEndDCA[NParentChildLinks]/D");
    fTree->Branch("OvershootEndL", &fOvershootEndL, "OvershootEndL[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionX", &fChildConnectionX, "ChildConnectionX[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionY", &fChildConnectionY, "ChildConnectionY[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionZ", &fChildConnectionZ, "ChildConnectionZ[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionDX", &fChildConnectionDX, "ChildConnectionDX[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionDY", &fChildConnectionDY, "ChildConnectionDY[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionDZ", &fChildConnectionDZ, "ChildConnectionDZ[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionDCA", &fChildConnectionDCA, "ChildConnectionDCA[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionExtrapDistance", &fChildConnectionExtrapDistance, "ChildConnectionExtrapDistance[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionL", &fChildConnectionL, "ChildConnectionL[NParentChildLinks]/D");
    fTree->Branch("ChildConnectionLRatio", &fChildConnectionLRatio, "ChildConnectionLRatio[NParentChildLinks]/D");
    fTree->Branch("ParentConnectionPointNUpstreamHits", &fParentConnectionPointNUpstreamHits, "ParentConnectionPointNUpstreamHits[NParentChildLinks]/D");
    fTree->Branch("ParentConnectionPointNDownstreamHits", &fParentConnectionPointNDownstreamHits, "ParentConnectionPointNDownstreamHits[NParentChildLinks]/D");
...
void FDSelection::CCNuSelection::Reset()
{
    ...
    for (int i = 0; i < kMaxPFParticles; i++)
    {
        ...
        fRecoPFPRecoParentTrackID[i] = kDefInt;
    ...
    ////////////////////////////////////////
    fNPrimaryLinks = 0;
    for (int i = 0; i < kMaxPrimaryLinks; i++)
    {
        // True - PrimaryTier
        fTruePrimaryLink[i] = false;
        fIsPrimaryLinkOrientationCorrect[i] = false;
        fTruePrimaryPDG[i] = kDefInt;
        fPrimaryCompleteness[i] = kDefDoub;
        fPrimaryPurity[i] = kDefDoub;
        // Reco - PrimaryTier
        fPrimaryPFPIndex[i] = kDefInt;
        fPrimaryNSpacepoints[i] = kDefInt;
        fPrimaryTrackScore[i] = kDefDoub;
        fPrimaryStartX[i] = kDefDoub;
        fPrimaryStartY[i] = kDefDoub;
        fPrimaryStartZ[i] = kDefDoub;
        fPrimaryStartDX[i] = kDefDoub;
        fPrimaryStartDY[i] = kDefDoub;
        fPrimaryStartDZ[i] = kDefDoub;
        fPrimaryNuVertexSeparation[i] = kDefDoub;
        fPrimaryStartRegionNHits[i] = kDefInt;
    ...
    for (int i = 0; i < kMaxParentChildLinks; i++)
    {
        ...
        fIsHigherTierTrainingLink[i] = false;
        fIsLinkOrientationCorrect[i] = false;
        // Parent information - HigherTier
        ...
        fParentNSpacepoints[i] = kDefDoub;
        fParentCompleteness[i] = kDefDoub;
        fParentPurity[i] = kDefDoub;
        fChildNSpacepoints[i] = kDefDoub;
        fChildCompleteness[i] = kDefDoub;
        fChildPurity[i] = kDefDoub;
        fVertexSeparation[i] = kDefDoub;
        fSeparation3D[i] = kDefDoub;
        fDoesChildConnect[i] = false;
        fOvershootStartDCA[i] = kDefDoub;
        fOvershootStartL[i] = kDefDoub;
        fOvershootEndDCA[i] = kDefDoub;
        fOvershootEndL[i] = kDefDoub;
        fChildConnectionX[i] = kDefDoub;
        fChildConnectionY[i] = kDefDoub;
        fChildConnectionZ[i] = kDefDoub;
        fChildConnectionDX[i] = kDefDoub;
        fChildConnectionDY[i] = kDefDoub;
        fChildConnectionDZ[i] = kDefDoub;
        fChildConnectionDCA[i] = kDefDoub;
        fChildConnectionExtrapDistance[i] = kDefDoub;
        fChildConnectionL[i] = kDefDoub;
        fChildConnectionLRatio[i] = kDefDoub;
	    fParentConnectionPointNUpstreamHits[i] = kDefDoub;
        fParentConnectionPointNDownstreamHits[i] = kDefDoub;
...
void FDSelection::CCNuSelection::FillHierarchyInfo(art::Event const & evt)
{
    ...
    for (art::Ptr<recob::PFParticle> pfp : pfps)
    {
        ...
        SetRecoGenerationInfo(evt, pfp, fRecoPFPRecoGeneration[pfpIndex], fRecoPFPRecoParentSelf[pfpIndex], fRecoPFPRecoParentPDG[pfpIndex], fRecoPFPRecoParentTrackID[pfpIndex]);
        SetTrueGenerationMCInfo(evt, pfpIndex, false, fRecoPFPTrueGeneration[pfpIndex], fRecoPFPTrueParentTrackID[pfpIndex], fRecoPFPTrueParentPDG[pfpIndex]);
        SetTrueGenerationMCInfo(evt, pfpIndex, true, fRecoPFPTrueVisibleGeneration[pfpIndex], fRecoPFPTrueVisibleParentTrackID[pfpIndex], fRecoPFPTrueVisibleParentPDG[pfpIndex]);
    }

    //SetTrueGenerationRecoInfo
    SetTrueGenerationRecoInfo(evt);
}

//////////////////////////////////////////////////////////////////////////////////
// This is basically what Pandora has already done
//////////////////////////////////////////////////////////////////////////////////
void FDSelection::CCNuSelection::SetRecoGenerationInfo(art::Event const & evt, const art::Ptr<recob::PFParticle> &pfp, 
    int &recoGeneration, int &recoParentSelf, int &recoParentPDG, int &recoParentTrackID)
{
    ...
    const art::Ptr<recob::PFParticle> &parentPFP = fPFPMap.at(parentID);

    recoParentSelf = parentPFP->Self();

    //// numpy arrays are great aren't they
    for (int i = 0; i < fNRecoPFPs; i++)
    {
        if (fRecoPFPSelf[i] == recoParentSelf)
        {
            recoParentPDG = fRecoPFPTruePDG[i];
            recoParentTrackID = fRecoPFPTrueTrackID[i];
        }
    }
}

//////////////////////////////////////////////////////////////////////////////////
// This is the true generation in terms of track IDs
//////////////////////////////////////////////////////////////////////////////////
void FDSelection::CCNuSelection::SetTrueGenerationMCInfo(art::Event const & evt, const int pfpIndex, const bool visibleMode, 
...
//////////////////////////////////////////////////////////////////////////////////
// This is the true generation in terms of PFP self
//////////////////////////////////////////////////////////////////////////////////
void FDSelection::CCNuSelection::SetTrueGenerationRecoInfo(art::Event const & evt)
{
    // Loop through our PFPs
    for (int pfpIndex = 0; pfpIndex < fNRecoPFPs; pfpIndex++)
    {
        ...
        // If parent is neutrino, put -1 or something
        if (parentTrackID == 0)
        {
            fRecoPFPTrueVisibleParentSelf[pfpIndex] = -1;
            fRecoPFPTrueVisibleParentPFPIndex[pfpIndex] = -1;
            continue;
        }
        ...
        if (parentIndex != -1)
        {
            fRecoPFPTrueVisibleParentSelf[pfpIndex] = fRecoPFPSelf[parentIndex];
            fRecoPFPTrueVisibleParentPFPIndex[pfpIndex] = parentIndex;
        }
    }

    /////////////////////////////////////////////////////
    // NEED TO CORRECT SPLITS - Work them out
    /////////////////////////////////////////////////////

    // First work out our split particles
    std::map<int, std::vector<int>> splitPFPs; // TrackID -> PFPIndex

    std::vector<int> trackIDVector; // this is just so we can use std::count
    for (int pfpIndex = 0; pfpIndex < fNRecoPFPs; pfpIndex++)
        trackIDVector.push_back(fRecoPFPTrueTrackID[pfpIndex]);

    // Loop through our PFPs
    for (int pfpIndex = 0; pfpIndex < fNRecoPFPs; pfpIndex++)
    {
        if (std::count(trackIDVector.begin(), trackIDVector.end(), fRecoPFPTrueTrackID[pfpIndex]) > 1)
            splitPFPs[fRecoPFPTrueTrackID[pfpIndex]].push_back(pfpIndex);
    }

    ///////////////////////////////////////////////////////////////////////////
    // NEED TO CORRECT SPLITS - Do parent-child links of the particle segments
    ///////////////////////////////////////////////////////////////////////////
    // Now sort of the parent-child links of the segments of the split particle
    for (auto &entry : splitPFPs)
    {
        // First order segments wrt distance to the true vertex
        std::vector<std::pair<int, double>> splitPFP;

        const TVector3 truePFPStart = TVector3(fRecoPFPTrueStartX[entry.second.at(0)], 
                                               fRecoPFPTrueStartY[entry.second.at(0)],
                                               fRecoPFPTrueStartZ[entry.second.at(0)]);

        for (int pfpIndex : entry.second)
        {
            if (fPFPMap.find(fRecoPFPSelf[pfpIndex]) == fPFPMap.end())
                throw;

            const art::Ptr<recob::PFParticle> &pfp = fPFPMap.at(fRecoPFPSelf[pfpIndex]);

            const double separation = HierarchyUtils::GetSeparation3D(evt, pfp, truePFPStart, fRecoModuleLabel);

            // This will happen if it is a 2D particle - ignore those..
            if (separation < 0)
                continue;

            splitPFP.push_back(std::pair<int, double>(pfpIndex, separation));
        }

        // Sort according to distance to true vertex
        // could do this with track start/end points (becomes complicated if its a shower :()
        std::sort(splitPFP.begin(), splitPFP.end(), 
             [](const std::pair<int, double> &a, const std::pair<int, double> &b)
             { 
                 return a.second < b.second; 
             });

        // Leave the first one - it should already be assigned
        // Now assign to whoever you are closer to.
        // Can always assign the second one
        for (unsigned int i = 1; i < splitPFP.size(); ++i)
        {
            const int pfpIndex = splitPFP.at(i).first;
            int parentPFPIndex = splitPFP.at(i - 1).first; // on the first iteration there's no ambiguity 
            ...
            if (i != 1)
            {
                ...
                const art::Ptr<recob::PFParticle> &thisPFP = fPFPMap.at(fRecoPFPSelf[pfpIndex]);

                // Here we have to find who we are closest to
                double closestSep = std::numeric_limits<double>::max();

                for (unsigned int j = 0; j < i; ++j)
                {
                    const int potentialParentPFPIndex = splitPFP.at(j).first;

                    if (fPFPMap.find(fRecoPFPSelf[potentialParentPFPIndex]) == fPFPMap.end())
                        throw;

                    const art::Ptr<recob::PFParticle> &potentialParentPFP = fPFPMap.at(fRecoPFPSelf[potentialParentPFPIndex]);

                    const double interHierarchySep = HierarchyUtils::GetSeparation3D(evt, thisPFP, potentialParentPFP, fRecoModuleLabel);

                    if ((interHierarchySep > 0) && (interHierarchySep < closestSep))
                    {
                        closestSep = interHierarchySep;
                        parentPFPIndex = potentialParentPFPIndex;
                    }
                }
            }

            fRecoPFPTrueVisibleParentTrackID[pfpIndex] = fRecoPFPTrueTrackID[parentPFPIndex];
            fRecoPFPTrueVisibleGeneration[pfpIndex] = (fRecoPFPTrueVisibleGeneration[parentPFPIndex] + 1);
            fRecoPFPTrueVisibleParentSelf[pfpIndex] = fRecoPFPSelf[parentPFPIndex];
            fRecoPFPTrueVisibleParentPFPIndex[pfpIndex] = parentPFPIndex;
        }
    }

    ///////////////////////////////////////////////////////////////////////////
    // NEED TO CORRECT SPLITS - Do parent-child links to the split particle
    ///////////////////////////////////////////////////////////////////////////
    if (!splitPFPs.empty())
    {
        for (int pfpIndex = 0; pfpIndex < fNRecoPFPs; pfpIndex++)
        {
            ...
            // If it is the split segment, we've kinda already dealt with it..
            ...
            // Is parent split
            if (splitPFPs.find(parentTrackID) == splitPFPs.end())
                continue;

            // See which parent the child is closest to
            if (fPFPMap.find(fRecoPFPSelf[pfpIndex]) == fPFPMap.end())
                throw;
            ...
            double closestSep = std::numeric_limits<float>::max();
            const std::vector<int> &parentIndexVector = splitPFPs.at(parentTrackID);

            for (int potentialParentIndex : parentIndexVector)
            {
                if (fPFPMap.find(fRecoPFPSelf[potentialParentIndex]) == fPFPMap.end())
                    throw;

                const art::Ptr<recob::PFParticle> &potentialParentPFP = fPFPMap.at(fRecoPFPSelf[potentialParentIndex]);
                const double interHierarchySep = HierarchyUtils::GetSeparation3D(evt, pfp, potentialParentPFP, fRecoModuleLabel);

                if ((interHierarchySep > 0) && (interHierarchySep < closestSep))
                {
                    closestSep = interHierarchySep;
                    parentPFPIndex = potentialParentIndex;
                }
            }
...
int FDSelection::CCNuSelection::GetPFPIndexFromTrackID(const int trackID)
{
    // Ensure no ambiguity
    int count = 0; 
    int pfpIndex = -1;
    
    for (int searchIndex = 0; searchIndex < fNRecoPFPs; ++searchIndex)
    {
        if (fRecoPFPTrueTrackID[searchIndex] == trackID)
        {
            ++count;
            pfpIndex = searchIndex;
        }
    }

    return (count == 1) ? pfpIndex : -1;
}
    ...
    const int pfpIndex)
{
    ...
    // Is inverted?
    if (fRecoPFPTrueTrackID[pfpIndex] >= 0) // does it have a match
    {
        const TVector3 trueStart = TVector3(fRecoPFPTrueStartX[pfpIndex], fRecoPFPTrueStartY[pfpIndex], fRecoPFPTrueStartZ[pfpIndex]); 
        const TVector3 recoStart = TVector3(fRecoTrackRecoStartX[pfpIndex], fRecoTrackRecoStartY[pfpIndex], fRecoTrackRecoStartZ[pfpIndex]);
        const TVector3 recoEnd = TVector3(fRecoTrackRecoEndX[pfpIndex], fRecoTrackRecoEndY[pfpIndex], fRecoTrackRecoEndZ[pfpIndex]);

        const double recoStartSepSq = (trueStart - recoStart).Mag2();
        const double recoEndSepSq = (trueStart - recoEnd).Mag2();

        fIsRecoTrackInverted[pfpIndex] = (recoEndSepSq < recoStartSepSq);
    }
...
void FDSelection::CCNuSelection::FillPrimaryLinkInfo(art::Event const & evt)
{
    if (!dune_ana::DUNEAnaEventUtils::HasNeutrino(evt, fRecoModuleLabel))
        return;
    ...
    for (art::Ptr<recob::PFParticle> pfp : pfps)
    {
        ...
        for (bool useRecoStart : {true, false})
        {
            ...
            // Truth
            fTruePrimaryLink[primaryLinkIndex] = (fRecoPFPTrueVisibleGeneration[pfpIndex] == 2);
            ...
            fPrimaryPurity[primaryLinkIndex] = fRecoPFPRecoHitPurity[pfpIndex];
            fPrimaryTrackScore[primaryLinkIndex] = fRecoPFPTrackShowerScore[pfpIndex];
            fPrimaryStartX[primaryLinkIndex] = linkVars["StartX"];
            fPrimaryStartY[primaryLinkIndex] = linkVars["StartY"];
            fPrimaryStartZ[primaryLinkIndex] = linkVars["StartZ"];
            fPrimaryStartDX[primaryLinkIndex] = linkVars["StartDX"];
            fPrimaryStartDY[primaryLinkIndex] = linkVars["StartDY"];
            fPrimaryStartDZ[primaryLinkIndex] = linkVars["StartDZ"];
            fPrimaryNuVertexSeparation[primaryLinkIndex] = linkVars["NuVertexSeparation"];
            fPrimaryStartRegionNHits[primaryLinkIndex] = linkVars["StartRegionNHits"];
...
bool FDSelection::CCNuSelection::IsPrimaryLinkOrientationCorrect(const int particleIndex, const bool useRecoStart)
{
    if (fRecoPFPTrackShowerScore[particleIndex] < 0.5)
        return true;
    else
        return fIsRecoTrackInverted[particleIndex] ? !useRecoStart : useRecoStart;
}
...
void FDSelection::CCNuSelection::FillParentChildLinkInfo(art::Event const & evt)
{
    ...
    for (art::Ptr<recob::PFParticle> parentPFP : parentPFPs)
    {
        ...
        for (art::Ptr<recob::PFParticle> childPFP : childPFPs)
        {
            ...
            // Do we want to train on this link?
            const bool isHigherTierTrainingLink = FDSelection::CCNuSelection::IsHigherTierTrainingLink(parentPFPIndex, childPFPIndex);
            ...
            // Get the variables unrelated to orientation
            const double separation3D = HierarchyUtils::GetSeparation3D(evt, parentPFP, childPFP, fRecoModuleLabel);    
            const double chargeRatio = kDefDoub;
            const int pidLinkType = HierarchyUtils::GetPIDLinkTypeWithIvysaurus(fRecoPFPIvysaurusParticleType[parentPFPIndex], fRecoPFPIvysaurusParticleType[childPFPIndex]);
            ...
            for (bool parentUseRecoStart : {true, false})
            {
                for (bool childUseRecoStart : {true, false})
                {
                    ...
                    // Fill out the things we already know
                    // Truth
                    ...
                    fParentNSpacepoints[linkIndex] = fRecoPFPRecoNSpacepoints[parentPFPIndex];
                    fParentCompleteness[linkIndex] = fRecoPFPRecoCompleteness[parentPFPIndex];
                    fParentPurity[linkIndex] = fRecoPFPRecoHitPurity[parentPFPIndex];
                    fParentTrackScore[linkIndex] = fRecoPFPTrackShowerScore[parentPFPIndex];
                    fChildNSpacepoints[linkIndex] = fRecoPFPRecoNSpacepoints[childPFPIndex];
                    fChildCompleteness[linkIndex] = fRecoPFPRecoCompleteness[childPFPIndex];
                    fChildPurity[linkIndex] = fRecoPFPRecoHitPurity[childPFPIndex];
                    fSeparation3D[linkIndex] = separation3D;
                    fChargeRatio[linkIndex] = chargeRatio;
                    fPIDLinkType[linkIndex] = pidLinkType;
                    fPIDLinkType_cheat[linkIndex] = pidLinkType_cheat;
...
bool FDSelection::CCNuSelection::IsLinkOrientationCorrect(const int parentIndex, const int childIndex, 
    const bool parentUseRecoStart, const bool childUseRecoStart)
{
    // Parent is always a track
    bool isParentCorrect = fIsRecoTrackInverted[parentIndex] ? parentUseRecoStart : !parentUseRecoStart;

    // Child can be track or shower
    bool isChildCorrect = false;
    if (fRecoPFPTrackShowerScore[childIndex] < 0.5)
        isChildCorrect = true;
    else
        isChildCorrect = fIsRecoTrackInverted[childIndex] ? !childUseRecoStart : childUseRecoStart;

    return isParentCorrect && isChildCorrect;
}

//////////////////////////////////////////////////////////////////////////////////

bool FDSelection::CCNuSelection::IsHigherTierTrainingLink(const int parentPFPIndex, const int childPFPIndex)
{
    // 1. Is it a good node?
...
bool FDSelection::CCNuSelection::IsTrueParentChildLink(const int parentPFPIndex, const int childPFPIndex)
{
    if (fRecoPFPTrueVisibleParentSelf[childPFPIndex] == fRecoPFPSelf[parentPFPIndex])
        return true;
    else
        return false;
}
