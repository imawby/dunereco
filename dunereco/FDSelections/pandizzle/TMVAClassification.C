...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   dataloader->AddVariable("MichelNHits","NHits in Michel candidate","",'F'/*, -105, 1000*/);
   dataloader->AddVariable("MichelElectronMVA","Electron-like MVA for Michel candidate","",'F'/*, -105, 2*/);
   dataloader->AddVariable("MichelRecoEnergyPlane2","Reco energy (col. plane) for Michel candidate","",'F'/*, -105, 4*/);
   dataloader->AddVariable("DeflecAngleSD","Track candidate scattering SD","",'F');
   dataloader->AddVariable("Length","Candidate track length","",'F');
   dataloader->AddVariable("EvalRatio","EvalRatio","",'F');
   ...
   dataloader->AddVariable("dEdxStart","dEdx (start)","",'F');
   dataloader->AddVariable("dEdxEnd","dEdx (end)","",'F');
   dataloader->AddVariable("dEdxEndRatio","dEdx (end/start ratio)","",'F');
...
//   factory->AddSpectator( "spec2 := var1*3",  "Spectator 2", "units", 'F' );
   ...
   TString fname = "pandizzleTrainingFile.root";
