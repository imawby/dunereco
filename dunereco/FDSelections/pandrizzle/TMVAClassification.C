...
void TMVAClassification( TString myMethodList = "" )
{
   ...
   TString fname = "/dune/app/users/imawby/selection/trainings/electronSelector/pandrizzleTrainingFile.root";
   ...
   TCut mycuts = "(RecoNHits > 100) && (Completeness > 0.5) && (Purity > 0.5)";
   //TCut mycuts = "";
