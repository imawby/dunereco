...
constexpr int kMaxMCParticles = 150;
constexpr int kMaxPFParticles = 100;

namespace FDSelection {
  class CCNuSelectionSAM;
}

class FDSelection::CCNuSelectionSAM : public art::EDAnalyzer {
public:
  explicit CCNuSelectionSAM(fhicl::ParameterSet const & p);
  CCNuSelectionSAM(CCNuSelectionSAM const &) = delete;
  CCNuSelectionSAM(CCNuSelectionSAM &&) = delete;
  CCNuSelectionSAM & operator = (CCNuSelectionSAM const &) = delete;
  CCNuSelectionSAM & operator = (CCNuSelectionSAM &&) = delete;
...
FDSelection::CCNuSelectionSAM::CCNuSelectionSAM(fhicl::ParameterSet const & pset) :
  EDAnalyzer(pset),
...
void FDSelection::CCNuSelectionSAM::analyze(art::Event const & evt)
{
...
void FDSelection::CCNuSelectionSAM::beginJob()
{
    ///////////////////////////
    // POT tree
    ///////////////////////////
    ...
    fTree->Branch("PFP_TrackShowerPDG", fRecoPFPTrackShowerPDG, "PFP_TrackShowerPDG[Event_NRecoPFPs]/I");
...
void FDSelection::CCNuSelectionSAM::beginSubRun(art::SubRun const & sr)
{
}

//////////////////////////////////////////////////////////////////////////////////

void FDSelection::CCNuSelectionSAM::endSubRun(const art::SubRun& sr)
{
}

//////////////////////////////////////////////////////////////////////////////////

void FDSelection::CCNuSelectionSAM::endJob()
{
}

//////////////////////////////////////////////////////////////////////////////////

void FDSelection::CCNuSelectionSAM::Reset()
{
    ////////////////////////////////////////
    // Pandora maps
    ////////////////////////////////////////
...
void FDSelection::CCNuSelectionSAM::FillPandoraMaps(art::Event const& evt)
{
    // MCParticle map
...
void FDSelection::CCNuSelectionSAM::GetTruthInfo(art::Event const & evt)
{
...
void FDSelection::CCNuSelectionSAM::FillVertexInfo(art::Event const & evt)
{
...
void FDSelection::CCNuSelectionSAM::FillPFParticleInfo(art::Event const & evt)
{
    if (!dune_ana::DUNEAnaEventUtils::HasNeutrino(evt, fRecoModuleLabel))
        return;
...
void FDSelection::CCNuSelectionSAM::FillRecoTrackInfo(art::Event const & evt, const art::Ptr<recob::PFParticle> &pfp,
    const int pfpIndex)
{
...
void FDSelection::CCNuSelectionSAM::FillRecoShowerInfo(art::Event const & evt, const art::Ptr<recob::PFParticle> &pfp,
    const int pfpIndex)
{
...
DEFINE_ART_MODULE(FDSelection::CCNuSelectionSAM)
